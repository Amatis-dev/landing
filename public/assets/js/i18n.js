  ...
  var dict = {
    ...
    /*__SVC_END__*/            svc: {
      ...
      aeo: {
        ...
        sumTitle: "Summary",
        sumHead: "AmatisBerry is an end-to-end digital consultancy. From product strategy to design, development, marketing and post-launch support, one team takes your idea to a live, growing product — with clear milestones, dedicated QA and long-term care.",
      },
      aeo2: {
        intro: "AmatisBerry is a full-service digital consultancy that partners with founders and growing businesses on the entire product journey. We combine business strategy, user experience design, cross-platform development, digital marketing and long-term technical care under one accountable roof, so you get a single integrated team instead of many disconnected vendors. Our milestone-based delivery model keeps budgets predictable and timelines realistic, and every project ships with dedicated quality assurance, clear documentation and a post-launch support roadmap.",
        ...
        aboutHead: "AmatisBerry is a business consultancy agency focused on long-term client outcomes rather than one-off deliverables. We operate with transparent, milestone-based delivery and share accountability for the results we help you reach.",
        ...
        qa1a: "Because growth depends on both. Our integrated teams align product, design and marketing goals from day one, so the product is built to be found, used and retained, not merely launched.",
        qa2q: "Can AmatisBerry support us after launch?",
        qa2a: "Yes. We offer maintenance, security updates, monitoring and iteration roadmaps so your product stays healthy and keeps improving long after go-live.",
        qa3q: "How transparent is the pricing process?",
        qa3a: "Completely. We agree scope up front, use a fixed-structure quote and report progress against clear milestones, so budgets and timelines stay predictable.",
